...
class HousingForm extends React.Component {
  ...
  submit(e, name, heading, street, city, state, zipCode, price, dateStart, dateEnd, interests, mission, rules, vacancies, primary, amenities, pic1, pic2, pic3, pic4, pic5){
    ...
    if (pic1.value === ''){
      ...
      Axios.post('//localhost:3000/v1/lp', fdata);
    }
    ...
    .then(() => {
      fetch('//localhost:3000/v1/listings?access_token='+authToken, {
        method: 'POST',
        headers: {
    ...
    return(
          ...
          <form>
            <label>House Name:</label><br/>
              <input 
                type='text'
                ref={ input => this.house_name = input }/>
              <br/>
            ...
            <br/>
              <input 
                type='text'
                ref={ input => this.street_add = input }/>
              <br/>
            ...
            <br/>
              <input 
                type="date"
                ref={ input => this.dates_start = input }/>
              <input 
                type="date"
                ref={ input => this.dates_end = input }/>
              <br/>
            ...
            <br/>
              <input 
                type='text'
                ref={ input => this.interests = input }/>
              <br/>
              <div>
              {this.state.interestsArray.map((value, i) => {
                return (
                  <div 
                    ...
                    <input 
                      type="checkbox" 
                      onChange={ e => this.addInterest(value) } />
                    <span> { value } </span>
                  </div>
                  )
              })}
            ...
            <br/>
              <textarea 
                ref={ input => this.house_mission = input }/>
              <br/>

            <label>House Rules:</label>
            <br/>
              <textarea 
                ref={ input => this.house_rules = input }/>
              <br/>
            ...
            <br/>
              <input 
                type="number" 
                min='0' 
                ref={ input => this.vacancies = input }/>
              <br/>
            ...
            <br/>
              <input 
                type='text'
                ref={ input => this.primary_member = input }/>
              <br/>
              ...
              <div>
                ...
                return (
                  <div 
                    ...
                    <input 
                      type="checkbox" 
                      onChange={ e => this.addAmenity(value) } />
                    <span> { value } </span>
                  </div>
                  )
              })}
            ...
            <form id='pic5Form'>
              ...
              <input 
                ...
                name='file' 
                className='fileUpload'
                ref={ input => this.pic5 = input } />
            </form>
            <br/>

            <input 
              id='housingSubmit' 
              onClick={ e => this.submit(e, this.house_name, this.heading, this.street_add, this.city, this.stateName, this.zipCode, this.price, this.dates_start, this.dates_end, this.interests, this.house_mission, this.house_rules, this.vacancies, this.primary_member, this.amenities, this.pic1, this.pic2, this.pic3, this.pic4, this.pic5) } 
              type='button' 
              value='Create House'/>
        </div>
      )
